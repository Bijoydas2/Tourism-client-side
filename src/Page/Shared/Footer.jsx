        ...
        <div className="mb-8 md:mb-0 md:w-1/3 grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <ul className="flex space-x-4">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition" aria-label="Twitter">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
              ...
              <li>
                <a href="#" className="text-gray-600 hover:text-blue-600 transition" aria-label="Instagram">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
