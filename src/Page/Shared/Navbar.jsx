 ...
 <div className="navbar-end">
  {!user ? (
    ...
    <div className="dropdown dropdown-end flex items-center gap-2">
      ...
      >
        <li className="px-3 py-2 font-semibold text-gray-700 truncate">{user.displayName || 'User'}</li>
        <li>
          <NavLink to="/add-package" className="hover:text-blue-600 px-3 py-2 rounded">
            Add Package
          </NavLink>
        </li>
        <li>
          <NavLink to="/manage-packages" className="hover:text-blue-600 px-3 py-2 rounded">
            Manage My Packages
          </NavLink>
        </li>
        <li>
